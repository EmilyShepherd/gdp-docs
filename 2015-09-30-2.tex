...
\topic{Project Brief}
The team agreed that the brief was appropriate; no-one had any proposed changes.
Emily suggested using the initial brief with little alteration.
...
\decision*{Keep all reports, minutes and code under Git version control, hosted on GitHub}
