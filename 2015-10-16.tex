...
mentioned that this would mean reduced voltages (of around 1V) and reduced frequencies. He stated
that any software, therefore, that was to be run on the device would need to be designed in the knowledge
that it would have very few processessing cycles available to it and that the memory would be very small.
...
Dr Weddell asked James to clarify what memory would be available - James responded that the system
...
would be no way to test this on the real device. Emily stated, therefore, that the team would use 8 kB
